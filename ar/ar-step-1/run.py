...
class Evaluator:
    ...
    def conll_score(self):
        ...
        output_path = join(self.runner.config['data_dir'], 'output_{}_{}_{}.jsonlines'.format(self.runner.name, self.runner.best_model_suffix, self.runner.config['test_dir']))
...
def batch_evaluate(gpu_id):
    test_files = [
        # ('all_train_dev.ar.pron10.split.30inTraining.jsonlines', None),
        ('AMI_test_no_men.2022.split.ar.pron10.split.jsonlines', None),
        ('Switchboard_test_Phase_1.2022.ar.pron10.jsonlines', None),
        ('Persuasion_test_no_men.2022.ar.pron10.jsonlines', None),
        ('light_test_no_men.2022.ar.pron10.jsonlines', None),
    ]
    configs = [
        ('codi2022_arpred_first_step_subm_tl500_30_nocons', 'model_Jun28_16-06-56_10.0.bin', 11),
        # ('codi2022_arpred_first_step_subm_tl500_30_nocons', 'model_Jun28_16-06-56_15.0.bin', 11),
        # ('codi2022_arpred_first_step_subm_tl500_30_nocons', 'model_Jun28_16-06-56_20.0.bin', 11),
        # ('codi2022_arpred_first_step_subm_tl500_30_nocons', 'model_Jun28_16-06-56_25.0.bin', 11),
    ]
